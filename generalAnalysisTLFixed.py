...
def train():
    ...
    model.load_state_dict(torch.load("modelGeneralAnalysis.pth"))
    ...
    for epoch in range(epochs):
        optimizer.zero_grad()
        loss, s1, s2 = getLossElastic(model, x_c, y_c, x_b, y_b, W_c, W_b, nu, Rho, [epochs / 25]*4, [epochs / 25]*4)
...
if __name__ ==  "__main__":
    ...
    ## condition.
    model = train()
    torch.save(model.state_dict(), "modelGeneralAnalysisFixed.pth")
